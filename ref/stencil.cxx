        ...
        for (ui64 y = 0; y < DIMY; y++) {
            for (ui64 x = 0; x < DIMX; x++) {
                ...
                for (ui64 o = 1; o <= order; o++) {
                    matC[DIMXYZ(x, y, z)] +=
                        matA[DIMXYZ(x + o, y, z)] * matB[DIMXYZ(x + o, y, z)] / pow(17.0, o);
                    matC[DIMXYZ(x, y, z)] +=
                        matA[DIMXYZ(x - o, y, z)] * matB[DIMXYZ(x - o, y, z)] / pow(17.0, o);
                    matC[DIMXYZ(x, y, z)] +=
                        matA[DIMXYZ(x, y + o, z)] * matB[DIMXYZ(x, y + o, z)] / pow(17.0, o);
                    matC[DIMXYZ(x, y, z)] +=
                        matA[DIMXYZ(x, y - o, z)] * matB[DIMXYZ(x, y - o, z)] / pow(17.0, o);
                    matC[DIMXYZ(x, y, z)] +=
                        matA[DIMXYZ(x, y, z + o)] * matB[DIMXYZ(x, y, z + o)] / pow(17.0, o);
                    matC[DIMXYZ(x, y, z)] +=
                        matA[DIMXYZ(x, y, z - o)] * matB[DIMXYZ(x, y, z - o)] / pow(17.0, o);
                }
            }
...
int main(const int argc, char** argv) {
    ...
    for (ui64 i = 0; i < iters; i++) {
        ...
        printf("_0_ ");
        for (ui64 i = 0; i < 5; i++)
            printf(" %18.15lf", matA[DIMXYZ(DIMX / 2 + i, DIMY / 2 + i, DIMZ / 2 + i)]);
